...
// Orbiting particles: distinct size, distance from center, speed and opacity.
const orbits = [
...
<template>
  ...
  >
    ...
    <!-- Inferred profile: surfaces as soon as the architect has spoken, BEFORE the image arrives. -->
    <Motion
      v-if="profile"
      key="profile"
